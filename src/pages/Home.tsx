    ...
    const handleScroll = () => {
      ...
      for (const sectionId of sections) {
        ...
        if (section) {
          ...
          if (
            currentScrollY >= sectionTop - windowHeight * 0.4 &&
  ...
  const scrollToNextSection = () => {
    ...
    for (let i = 0; i < sections.length; i++) {
      ...
      if (section) {
        ...
        if (
          currentScrollY >= sectionTop - windowHeight * 0.3 &&
    ...
    <div className="min-h-screen theme-bg theme-text transition-colors duration-300">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              ...
              backgroundSize:
                window.innerWidth < 768 ? '40px 40px' : '60px 60px',
            }}
          />
          ...
          >
            <defs>
              ...
              >
                ...
                <stop
                  offset="100%"
                  stopColor={theme === 'dark' ? '#1E40AF' : '#005F73'}
                  stopOpacity="0.5"
                >
                  <animate
                    attributeName="stop-opacity"
                    values="0.5;0.9;0.3;0.5"
                    dur="5s"
                    repeatCount="indefinite"
                  />
                </stop>
          ...
          <div
            className={`absolute inset-0 ${theme === 'dark' ? 'opacity-20' : 'opacity-25'}`}
          >
            {[...Array(10)].map((_, i) => (
              <motion.div
                key={`matrix-${i}`}
          ...
          <motion.div
            ...
            className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full border ${
              theme === 'dark' ? 'border-blue-400/15' : 'border-cyan-500/20'
            }`}
            style={{
          ...
          {theme === 'light' && (
            <div className="absolute inset-0 opacity-15">
              <div
                ...
                style={{
                  backgroundImage:
                    'radial-gradient(circle at 20% 20%, rgba(0, 123, 255, 0.4) 0%, transparent 60%), radial-gradient(circle at 80% 80%, rgba(0, 95, 117, 0.35) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(0, 200, 255, 0.3) 0%, transparent 70%)',
                }}
              />
            </div>
          )}
          ...
          <div className="text-center space-y-6 sm:space-y-8 lg:space-y-10 max-w-4xl mx-auto">
            ...
            >
              ...
              >
                Digital
                <span
                  className={`ml-2 sm:ml-3 md:ml-4 lg:ml-5 ${
                    theme === 'dark'
              ...
              >
                <p
                  className={`text-lg sm:text-xl md:text-2xl font-medium font-heading ${
                    theme === 'dark' ? 'text-white' : 'text-black'
                  }`}
                >
                  Design inteligente. Código eficiente. Resultados que impactam.
                </p>
              </motion.div>
              ...
              >
                <p
                  className={`text-base sm:text-lg md:text-xl leading-relaxed font-body ${
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h2
              className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 font-heading ${
                theme === 'dark'
            ...
            <p
              className={`text-lg sm:text-xl max-w-3xl mx-auto font-body px-4 sm:px-0 ${
            ...
            {[
              {
                ...
                description:
                  'Sites responsivos, landing pages e e-commerce com tecnologias modernas como React, Next.js e Node.js',
              ...
              },
              {
                ...
                title: 'UI/UX Design',
                description:
                  'Design de interfaces intuitivas, protótipos interativos e experiências centradas no usuário',
              ...
              },
              {
                ...
                description:
                  'SEO, gestão de redes sociais, campanhas de tráfego pago e automação de marketing',
              ...
              >
                <div
                  className={`inline-flex p-3 sm:p-4 rounded-xl sm:rounded-2xl mb-4 sm:mb-6 ${
                    theme === 'dark'
                ...
                <h3
                  className={`text-xl sm:text-2xl font-bold mb-3 sm:mb-4 font-heading ${
                ...
                <p
                  className={`text-sm sm:text-base lg:text-lg leading-relaxed font-body ${
                    theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
                  }`}
                >
                  {service.description}
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              Conheça nossos trabalhos mais recentes e veja como transformamos
            ...
            {[
              {
                ...
                description:
                  'Sistema completo de cardápio digital com painel administrativo para gestão de categorias, produtos e promoções. Inclui integração com WhatsApp para pedidos.',
              ...
              },
              {
                ...
                description:
                  'Sistema de cardápio digital sem necessidade de banco de dados, com interface moderna e responsiva para estabelecimentos que precisam de uma solução rápida.',
              ...
              >
                ...
                <div className="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
                  ...
                  <div
                    className={`hidden w-full h-full bg-gradient-to-br ${project.gradient} items-center justify-center relative`}
                  >
                    <div
                      className={`text-6xl sm:text-7xl lg:text-8xl opacity-40 ${
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <p
                    className={`text-sm sm:text-base lg:text-lg leading-relaxed font-body mb-6 ${
                      theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
                    }`}
                  >
                    {project.description}
      ...
      <section
        className={`py-20 ${theme === 'dark' ? 'bg-gradient-to-b from-black/30 to-gray-900/20' : 'bg-gradient-to-b from-white to-blue-50/30'}`}
      >
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              Depoimentos reais de clientes que transformaram seus negócios
              conosco
            </p>
          </motion.div>
      ...
      <section
        id="stats"
        className={`min-h-screen flex items-center justify-center py-16 sm:py-20 lg:py-24 ${theme === 'dark' ? 'bg-gray-900/30' : 'bg-blue-50/40'}`}
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
            {[
              ...
              >
                <div
                  className={`inline-flex p-3 sm:p-4 rounded-xl sm:rounded-2xl mb-3 sm:mb-4 ${
                    theme === 'dark'
                      ? 'bg-gradient-to-r from-cyan-500/20 to-blue-500/20'
                      : 'bg-gradient-to-r from-blue-500/15 to-cyan-500/15'
                  }`}
                ...
                <div
                  className={`text-2xl sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2 font-heading ${
                    theme === 'dark' ? 'text-white' : 'text-gray-900'
                  }`}
                >
                  {stat.number}
                ...
                <div
                  className={`text-xs sm:text-sm lg:text-base font-body ${
                    theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                  }`}
                >
                  {stat.label}
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <h2
              className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 font-heading ${
                theme === 'dark'
                  ? 'bg-gradient-to-r from-white to-cyan-300 bg-clip-text text-transparent'
                  : 'bg-gradient-to-r from-gray-900 to-blue-600 bg-clip-text text-transparent'
              }`}
            ...
            <p
              className={`text-lg sm:text-xl md:text-2xl mb-8 sm:mb-10 lg:mb-12 max-w-2xl mx-auto font-body px-4 sm:px-0 ${
                theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
              }`}
            >
              Pronto para levar seu negócio ao próximo nível? Nossa equipe está
              preparada para transformar suas ideias em soluções digitais de
              alta performance.
            </p>
