  ...
  const services = [
    {
      ...
      description:
        'Sites modernos, responsivos e otimizados para performance. Combinamos design atraente com tecnologia de ponta para criar uma presença digital marcante para sua marca.',
      features: [
    ...
    },
    {
      ...
      description:
        'Desenvolvemos aplicações web robustas que automatizam processos e impulsionam a eficiência do seu negócio, com foco em usabilidade e escalabilidade.',
      features: [
        'Arquitetura moderna e escalável',
    ...
    },
    {
      ...
      title: 'Apps Mobile',
      description:
        'Aplicativos nativos e híbridos para iOS e Android que oferecem experiência superior aos usuários, com foco em performance e usabilidade.',
      features: [
    ...
    },
    {
      ...
      title: 'Landing Pages',
      description:
        'Páginas web estratégicas com design moderno e responsivo, focadas em apresentar seu produto ou serviço de forma eficiente e profissional.',
      features: [
    ...
    },
    {
      ...
      title: 'SEO',
      description:
        'Otimização para mecanismos de busca que melhora seu posicionamento orgânico e aumenta sua visibilidade nos resultados de pesquisa.',
      features: [
        'Otimização on-page',
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Soluções digitais completas para impulsionar seu negócio no mundo
              digital
            </motion.p>
          </motion.div>
      ...
      >
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p
              className={`text-lg max-w-2xl mx-auto ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}
            >
            ...
            {[
              {
                ...
                description:
                  'Compreendemos suas necessidades, analisamos requisitos e criamos um plano detalhado para o projeto.',
              },
              {
                title: 'Design e Prototipagem',
                description:
                  'Criamos wireframes e protótipos para visualizar a solução antes do desenvolvimento.',
              },
              {
                title: 'Desenvolvimento',
                description:
                  'Implementamos a solução utilizando as tecnologias mais adequadas, seguindo as melhores práticas.',
              },
              {
                title: 'Testes e Lançamento',
                description:
                  'Realizamos testes rigorosos e ajustes finais antes de lançar o produto ao público.',
              },
            ].map((step, index) => (
              <motion.div
                key={index}
                className={`backdrop-blur-md p-8 rounded-xl border relative ${
                  theme === 'dark'
              ...
              >
                ...
                {index < 3 && (
                  <div
                    className={`hidden lg:block absolute top-1/2 right-0 w-8 h-0.5 ${theme === 'dark' ? 'bg-cyan-500/30' : 'bg-blue-500/30'} translate-x-4`}
                  ></div>
                )}
              </motion.div>
            ))}
            ...
            {[
              {
                ...
                answer:
                  'O prazo varia de acordo com a complexidade do projeto. Um site institucional simples pode levar de 2 a 4 semanas, enquanto aplicações web mais complexas podem levar de 2 a 6 meses. Fornecemos um cronograma detalhado no início do projeto.',
                icon: <Clock className="w-6 h-6" />,
              },
              {
                question: 'Como funciona o processo de pagamento?',
                answer:
                  'Trabalhamos com um modelo de pagamento em etapas. Geralmente, 30% no início do projeto, 30% na entrega dos protótipos e 40% na conclusão. Para projetos maiores, podemos criar um plano de pagamento personalizado.',
                icon: <Target className="w-6 h-6" />,
              },
              {
                question: 'Vocês oferecem suporte após o lançamento?',
                answer:
                  'Sim, oferecemos planos de suporte e manutenção mensais que incluem atualizações, correções de bugs, backups regulares e pequenas melhorias. Também fornecemos treinamento para que sua equipe possa gerenciar o conteúdo.',
                icon: <Users className="w-6 h-6" />,
              },
              {
                question: 'Quais tecnologias vocês utilizam?',
                answer:
                  'Utilizamos tecnologias modernas e robustas como React, Next.js, Node.js, Python, Django, Laravel, AWS, entre outras. A escolha da tecnologia depende das necessidades específicas do seu projeto para garantir a melhor performance e escalabilidade.',
