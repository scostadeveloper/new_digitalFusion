        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <div className="mb-12">
              <h2>Introdução</h2>
              <p>
                A Digital Fusion está comprometida em proteger a privacidade e os dados pessoais de nossos usuários. 
            ...
            <div className="mb-12">
              ...
              <ul>
                ...
                <li>Com parceiros de confiança que nos auxiliam na prestação de serviços</li>
              </ul>
            </div>
