      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <motion.div 
            ...
            style={{
              ...
              backgroundSize: typeof window !== 'undefined' && window.innerWidth < 768 ? '40px 40px' : '60px 60px',
            }}
          />
          ...
          <svg className="absolute inset-0 w-full h-full" style={{ opacity: theme === 'dark' ? 0.6 : 0.7 }}>
            <defs>
              <linearGradient id="portfolioCircuitGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="50%" stopColor={theme === 'dark' ? '#3B82F6' : '#00C9FF'} stopOpacity="0.7">
                  <animate attributeName="stop-opacity" values="0.7;0.9;0.4;0.7" dur="3s" repeatCount="indefinite" />
                </stop>
                <stop offset="100%" stopColor={theme === 'dark' ? '#1E40AF' : '#0056B3'} stopOpacity="0.5">
                  <animate attributeName="stop-opacity" values="0.5;0.8;0.3;0.5" dur="5s" repeatCount="indefinite" />
                </stop>
              </linearGradient>
              ...
              >
                {Array.from({ length: 20 }, (_, j) => (
                  <div key={j} style={{ opacity: 1 - (j * 0.05) }}>
                    {['01', '10', '{}', '[]', '<>', '/>', 'AI', 'WEB'][Math.floor(Math.random() * 8)]}
                  </div>
                ))}
              </motion.div>
            ))}
          ...
          <motion.div
            ...
            style={{
              width: typeof window !== 'undefined' && window.innerWidth < 768 ? '300px' : '500px',
              height: typeof window !== 'undefined' && window.innerWidth < 768 ? '300px' : '500px',
              background: theme === 'dark' 
          ...
          {theme === 'light' && (
            <div className="absolute inset-0 opacity-10">
              <div 
                ...
                style={{
                  backgroundImage: 'radial-gradient(circle at 30% 30%, rgba(0, 123, 255, 0.3) 0%, transparent 50%), radial-gradient(circle at 70% 70%, rgba(0, 95, 117, 0.25) 0%, transparent 40%)',
                }}
              />
            </div>
          )}
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center px-4">
          ...
          >
            ...
            Cada projeto é único e criado especialmente para atender às necessidades dos nossos clientes.
          </motion.p>
          ...
          >
            {[
              { icon: <Code className="w-4 h-4" />, text: 'Desenvolvimento Web' },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className={`text-lg max-w-2xl mx-auto ${
              ...
              Cada projeto é uma história de sucesso, desenvolvido com tecnologias modernas e foco na experiência do usuário.
            </p>
          </motion.div>
