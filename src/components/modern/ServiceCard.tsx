  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Corner Decorations */}
        <div className={`absolute top-4 left-4 w-8 h-8 border-l-2 border-t-2 rounded-tl-lg opacity-30 group-hover:opacity-100 transition-opacity duration-300 ${
          theme === 'dark' ? 'border-cyan-400' : 'border-blue-500'
        }`} />
        <div className={`absolute top-4 right-4 w-8 h-8 border-r-2 border-t-2 rounded-tr-lg opacity-30 group-hover:opacity-100 transition-opacity duration-300 ${
          theme === 'dark' ? 'border-cyan-400' : 'border-blue-500'
        }`} />
        <div className={`absolute bottom-4 left-4 w-8 h-8 border-l-2 border-b-2 rounded-bl-lg opacity-30 group-hover:opacity-100 transition-opacity duration-300 ${
          theme === 'dark' ? 'border-cyan-400' : 'border-blue-500'
        }`} />
        <div className={`absolute bottom-4 right-4 w-8 h-8 border-r-2 border-b-2 rounded-br-lg opacity-30 group-hover:opacity-100 transition-opacity duration-300 ${
          theme === 'dark' ? 'border-cyan-400' : 'border-blue-500'
        }`} />
        ...
        <div className="relative z-10">
          ...
          {/* Content */}
          <h3 className={`text-xl lg:text-2xl font-bold mb-4 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r transition-all duration-300 ${
            theme === 'dark' 
